...
export default function ForgetPasswordPage() {
  ...
  const {
    mutate: resuestPasswordResetEmail,
    isPending: isResuestPasswordResetEmail,
  } = useRequestPasswordResetEmail({
    onSuccess: () => {
      toast.info("이메일을 보냈습니다. 메일함을 확인해주세요.", {
        position: "top-center",
      });
      setEmail("");
    },
  ...
  const handleSendEmailClick = () => {
    ...
    resuestPasswordResetEmail(email);
  };
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <Input
        disabled={isResuestPasswordResetEmail}
        value={email}
